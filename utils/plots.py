...
def scatter_plot(x, y, xlabel='Epochs', ylabel='Average Reward', filename='reward', save_dir=''):
...
def errorbar_plot(x, y, xlabel='Epochs', ylabel='Average Reward', filename='reward', error=None, save_dir=''):
    fig, ax = plt.subplots(1, 1, figsize=(6, 5))
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
